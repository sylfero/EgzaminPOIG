...
{
    class CourierExpress : Parcel
    {
        public CourierExpress(IPerson sender, IPerson recipient, uint weight, uint width, uint length, uint height)
